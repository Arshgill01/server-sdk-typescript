...
export interface operations {
    createCall: {
        ...
        responses: {
            ...
            /** @description An account concurrency limit (`account_concurrency_exceeded`), or LLM token budget (`llm_token_budget_exceeded`) was reached. Account admission is checked before planning. */
            429: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                     ...
                     *         "message": "This account has reached its task concurrency limit for the selected outbound line. Wait for a task to finish and retry.",
                     *         "details": {}
                     *       }
                     *     }
                     */
